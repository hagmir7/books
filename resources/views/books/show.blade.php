                ...
                <div class="sticky-left-column">
                    ...
                    <div class="download read py-3">
                        ...
                        <a rel="nofollow" href="https://file.best/{{ request()->path() }}"
                            class="w-100 btn btn-success btn-rounded d-flex justify-content-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="whole-rating">
                            <span class="average">{{ $rating ? $rating : 5 }} {{ __("Avg rating") }}</span><span
                                class="separator">—</span><span>{{ $book->comments->count() ? $book->comments->count() :
                                2 }}</span>
                            {{ __("Votes") }}
                        </div>
                    </div>
                ...
                <table class="table book-meta" style="--bs-body-bg: none;">
                    <tbody>
                        ...
                        <tr>
                            <td>{{ __("Pages") }}:</td>
                            <td>
                                <span itemprop="numberOfPages">{{ $book->pages ? $book->pages : "__" }} {{ __("pages")
                                    }}</span>
                            </td>
                        </tr>
                        ...
                        <ul class="pagination d-flex justify-content-between">
                            <li class="page-item">
                                ...
                                <a class="page-link btn btn-primary"
                                    href="{{ route('book.show', $book->previous()->slug) }}" aria-label="Previous">
                            ...
                            <li class="page-item">
                                @if($book->next())
                                <a class="page-link btn btn-primary"
                                    href="{{ route('book.show', $book->next()->slug) }}" aria-label="Next">
