            ...
            <div class="w-full">
                ...
                <div class="social-btns mt-6 flex flex-wrap justify-center gap-3">
                    ...
                    <a target="_blank" aria-label="{{ __('Share with Facebook') }}"
                        href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->fullUrl()) }}&quote={{ urlencode($post->title) }}"
                    ...
                    <a target="_blank" aria-label="{{ __('Share with Pinterest') }}"
                        href="https://pinterest.com/pin/create/button/?url={{ urlencode(request()->fullUrl()) }}&description={{ urlencode($post->title) }}&media={{ urlencode($post->thumbnail ?? '') }}"
