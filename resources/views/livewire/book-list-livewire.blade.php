        ...
        <div class="flex flex-wrap">
            <div class="w-full" id="book-list">
               <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                ...
                <div class="group">
                    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden h-full">
                        <div class="flex p-4 sm:p-5 gap-3 sm:gap-4">
                            ...
                            <div class="flex-1 flex flex-col min-w-0">
                                ...
                                <h3 class="mb-1.5 sm:mb-2 whitespace-nowrap text-ellipsis overflow-hidden">
                                    <a href="{{ route('book.show', $book->slug) }}" class="text-sm sm:text-base md:text-lg font-semibold text-gray-900 hover:text-primary transition-colors duration-200 line-clamp-2 leading-snug">
                                        {{ $book->name }}
                                    </a>
                                </h3>
                ...
                <div class="col-span-full flex flex-col items-center justify-center py-16 px-4">
                    <div class="bg-gray-50 rounded-full p-6 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" class="text-gray-300">
                    ...
                    <p class="text-sm text-gray-500 text-center max-w-sm">
                        We couldn't find any books matching your criteria. Try adjusting your filters or check back later.
                    </p>
                </div>
                @endforelse
            </div>
