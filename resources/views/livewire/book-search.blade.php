<div>
    <style>
        ...
        .card.border-0.rounded-3.overflow-hidden::-webkit-scrollbar {
            width: 6px;
        }

        .card.border-0.rounded-3.overflow-hidden::-webkit-scrollbar-thumb {
            background-color: #bbb;
            border-radius: 3px;
        }
    </style>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-11 col-md-10 col-lg-8 col-xl-8">
                    <div class="border-0 rounded-3 shadow-sm overflow-hidden poistion-absolute end-0 start-0">
                        <div class="card-body p-0">
                            ...
                            <div wire:loading.remove>
                                ...
                                @if($loop->first)
                                <div class="card border-0 rounded-3 overflow-hidden  scroll-results">
                                    <div class="card-header bg-light border-0 py-2 py-md-3 mb-2 mb-md-3">
                                    ...
                                    <div class="p-0 m-0">
                                        <div class="list-group-item border-0 py-0 px-3 bg-white hover-bg-light">
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="{{ route('authors.show', $book->author->slug) }}"
                                                    ...
                                                    <p class="mb-2 text-secondary d-flex align-items-center gap-2">
                                                        ...
                                                        <span class="fw-semibold small">{{ $book->author->full_name}}</span>
                                                    </p>
                                                </a>
                                                @endif
                                            </div>
                                        </div>
                                        <hr class="text-gray mx-3 mx-md-4">
                                    </div>
