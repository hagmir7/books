            ...
            <div class="w-full flex justify-center">
                <div>
                    ...
                    <div class="w-full mb-6">
                        <h1 class="text-xl md:text-2xl font-semibold text-gray-900">{{ __("Contact Us") }}</h1>
                    </div>
                    <div class="page-content max-w-4xl">
                        ...
                        <h2 id="get-in-touch" class="text md:text-xl font-bold text-gray-900 mb-4 mt-8">
                            {{ __("Get in Touch") }}
                        </h2>
                        <ul class="space-y-3 mb-8">
                            <li class="flex items-start gap-2">
                                ...
                                <span class="text-gray-700">
                                    ...
                                    @if (app("site")->email)
                                    <a href="mailto:{{ app('site')->email }}" class="text-primary hover:underline transition-colors">
                                        {{ app("site")->email }}
                                    </a>
                                    @endif
                                </span>
                        ...
                        <h2 id="send-us-a-message" class="text-md md:text-xl font-bold text-gray-900 mb-4 mt-8">
